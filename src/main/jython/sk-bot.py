...
class Perish:
	cabrach = "perish-cabrach.png"
	rhynie = "perish-rhynie.png"
...
class SXVillage:
	sxv01 = Pattern("sarxos-village-1.png").similar(1.00)
	sxv02 = Pattern("sarxos-village-2.png").similar(1.00)
	sxv03 = "sarxos-village-3.png"
